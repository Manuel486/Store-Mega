...
public class CtrlCliente implements ActionListener, ItemListener, MouseListener {
   ...
   /*
    ...
    public void limpiar(){
        pnl.txtId.setText(null);
        pnl.txtNombre.setText(null);
        pnl.txtApellido.setText(null);
        pnl.txtDni.setText(null);
        pnl.txtTelefono.setText(null);
        pnl.txtDireccion.setText(null);        
    }
